...
source.include_exts = py,png,jpg,jpeg,ttf,kv,atlas,md
...
requirements = python3,kivy==2.3.0,kivymd==1.2.0,pillow,requests,certifi,urllib3,charset-normalizer,idna,pyjnius,android,yt-dlp,mutagen,websockets,brotli,pycryptodomex
...
# 2) A directory, here  'legal_name' must contain resources of one kind
# android.add_resources = legal_name:path/to/directory1,legal_name2:path/to/directory2
# 3) A directory or file to add to resources. In this case the resource names will be derived from the file or directory name
# android.add_resources = path/to/file1,path/to/directory2
